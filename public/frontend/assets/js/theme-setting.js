...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (localStorage.getItem("template") === "dark") {
        ...
        darkBtn.classList.add("active", "text-light");
        darkBtn.innerHTML = `<i class="ri-sun-fill"></i>`;
    }
    ...
    darkBtn.addEventListener("click", () => {
        ...
        if (document.body.classList.contains("dark")) {
            ...
            darkBtn.classList.remove("active", "text-light");
            darkBtn.classList.add("text-dark");
            darkBtn.innerHTML = `<i class="ri-moon-fill"></i>`;
        }
    });
