...
@section('title', 'Today\'s Deal Product')
@push('header_script')
    <style>
        .select-option-box {
            opacity: 0;
    ...
    <div class="container">
        <div class="mb-8">
            ...
            <div class="flex-center-between mb-3">
                <h3 class="font-size-25 mb-0">Today's Deal</h3>
            </div>
                    ...
                    @empty
                        <div class="col-12 w-100 text-center py-5">
                            <div class="no-product-found mx-auto" style="max-width: 400px;">
                                ...
                                <p class="text-muted">Sorry, we couldn't find any products matching your current filters.
                                    Try adjusting your
                                    search or filters.</p>
