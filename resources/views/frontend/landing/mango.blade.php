...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-PBPJZVR5');
    </script>
...
<body class="pb-16 md:pb-0 bg-gray-50 text-slate-800">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PBPJZVR5" height="0" width="0"
    ...
    <script>
        ...
        function saveCart() {
            const d = new Date();
            d.setTime(d.getTime() + (7 * 24 * 60 * 60 * 1000));
            document.cookie = "cart=" + encodeURIComponent(JSON.stringify(cart)) + "; expires=" + d.toUTCString() +
                "; path=/";
        }
        ...
        function renderCart() {
            ...
            box.innerHTML +=
                `<div class="border-t pt-2 flex justify-between font-bold"><span>মোট</span><span>৳${toBanglaNumber(totalPrice)}</span></div>`;
            badge.innerText = toBanglaNumber(cart.length);
